...
class SparseScalarVector implements Iterable<TableEntry> {

    final int INITIAL_SIZE = 8;
    final num DEFAULT_LOAD_FACTOR = 0.6;
    int modulo;
    List<int> keys;
    List<num> values;
    int keyCount;
    ...
    SparseScalarVector([int initialSize]) {
    ...
    void _expand() {
        SparseScalarVector h = new SparseScalarVector(values.length * 2);
